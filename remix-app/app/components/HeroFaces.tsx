...
export function HeroFaces({}) {
  return (
    <>
      ...
      {/* </div> */}
      <div className="z-20 absolute flex flex-col bottom-[14%] pl-6 sm:pl-8 md:pl-12 text-white uppercase">
      ...
      <div className="flex flex-col -mt-[30%] md:-mt-[4em] [&_img]:max-w-[340px] [&_img]:grayscale [&_img]:hover:grayscale-0 [&_img]:transition [&_img]:duration-250 [&_img]:brightness-50 [&_img]:hover:brightness-100">
        <div className="w-full inline-flex flex-nowrap overflow-hidden">
          <ul className="flex items-center justify-center md:justify-start [&_img]:max-w-[350px] animate-infinite-scroll">
