...
export const PERSONS_QUERY = groq`*[_type in ["actor", "actress"] && defined(slug.current)] | order(publishedAt desc)`
...
export const ABOUT_QUERY = groq`*[_type == "about" && slug.current == "main"][0]`
